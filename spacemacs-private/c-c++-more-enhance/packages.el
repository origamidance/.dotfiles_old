...
(defun c-c++-more-enhance/init-disaster ()
...
(defun c-c++-more-enhance/init-clang-format ()
  (use-package clang-format
    :if c-c++-enable-clang-support))

(defun c-c++-more-enhance/init-cmake-mode ()
...
(when (configuration-layer/layer-usedp 'auto-completion)
  (defun c-c++-more-enhance/init-company-c-headers ()
...
(defun c-c++-more-enhance/init-gdb-mi ()
  (use-package gdb-mi
    :defer t
    :init
    (setq
...
(defun c-c++-more-enhance/post-init-stickyfunc-enhance ()
...
;; (defun c-c++-more-enhance/post-init-company-ycmd ()
;;   (push 'company-ycmd company-backends-c-mode-common))

(defun c-c++-more-enhance/pre-init-xcscope ()
  (spacemacs|use-package-add-hook xcscope
    :post-init
    (dolist (mode '(c-mode c++-mode))
      (evil-leader/set-key-for-mode mode "mgi" 'cscope-index-files))))

(defun c-c++-more-enhance/pre-init-helm-cscope ()
  (spacemacs|use-package-add-hook xcscope
    :post-init
    (dolist (mode '(c-mode c++-mode))
