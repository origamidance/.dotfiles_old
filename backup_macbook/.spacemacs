...
(custom-set-variables
 ...
 '(LaTeX-includegraphics-read-file (quote LaTeX-includegraphics-read-file-TeX))
 '(TeX-view-program-list (quote (("MuPDF" ("mupdf %s.pdf") "mupdf"))))
 ...
 '(org-capture-templates
   (quote
    (("t" "TODO" entry
      (file+headline "~/GTD/inbox.org" "Todos")
      "* TODO %?
Added: %U
" :prepend t)
     ("i" "IDEAS" entry
      (file+headline "~/GTD/inbox.org" "Ideas")
      "* IDEA %?
Added: %U
" :prepend t))))
 '(org-publish-project-alist
   (quote
    (("html" :base-directory "../org/" :base-extension "org" :publishing-directory "../public/" :recursive t :publishing-function org-html-publish-to-html :auto-preamble t))))
